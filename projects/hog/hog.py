...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while num_rolls > 0:
        ...
        if result == 1:
            exist_one = True
    return 1 if exist_one else ans
    # END PROBLEM 1
...
def more_boar(player_score, opponent_score):
    ...
    while opponent_score >= 100:
        opponent_score //= 10
    play_one, play_two = player_score // 10, player_score % 10
    oppo_one, oppo_two = opponent_score // 10, opponent_score % 10
    return play_one < oppo_one and play_two < oppo_two
    # END PROBLEM 4
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            if not more_boar(score1, score0):
                who = next_player(who)
        real_say = real_say(score0, score1)
...
def more_boar_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    boar = score + piggy_points(opponent_score)
    return 0 if more_boar(boar, opponent_score) else piggypoints_strategy(score, opponent_score, cutoff, num_rolls)
    # END PROBLEM 11
